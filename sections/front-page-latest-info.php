...
<section id="latest-info" class="front-page-section">
    ...
    <div class="container">
        ...
        $infos_slide_query = new WP_Query([
            'posts_per_page'   => 8,
            'orderby'            => 'rand',
            'category__not_in' => [QI_THOUGHTS_CAT_ID, QI_POETRY_CAT_ID],
        ]);
                    ...
                    <div class="infos-owl-item card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="<?= get_permalink() ?>"
                               class="btn btn-light"><?= __("View Info", 'qi-theme') ?></a>
                        </div>
                    </div>
                <?php endwhile; ?>
            </div>
    ...
    if ($button_text && $button_url): ?>
        <a href="<?php echo esc_url($button_url); ?>" title="<?php echo esc_attr($button_text); ?>"
           class="latest-info-button"><?php echo esc_html($button_text); ?> <i
                    class="fa fa-chevron-circle-<?= is_rtl() ? "left" : "right" ?>"></i></a>
    <?php endif; ?>

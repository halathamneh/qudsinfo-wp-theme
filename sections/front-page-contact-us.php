					...
					<div class="row" style="margin-bottom: 45px;">
						...
						<div class="col-sm-6">
							<div class="contact-us-box">
								...
								<div class="box-right">
									<?php if( $email ): ?>
										<span class="box-right-row"><?php _e( 'البريد الإلكتروني :', 'illdy' ); ?> <a href="mailto:<?php echo esc_attr( $email ); ?>" title="<?php echo esc_attr( $email ); ?>"><?php echo esc_html( $email ); ?></a></span>
									<?php endif; ?>
									<?php if( $phone ): ?>
										<span class="box-right-row" data-customizer="contact-us-phone"><?php _e( 'رقم الهاتف :', 'illdy' ); ?> <?php echo illdy_sanitize_html( $phone ); ?></span>
									<?php endif; ?>
								</div><!--/.box-right-->
							</div><!--/.contact-us-box-->
						</div><!--/.col-sm-5-->
					...
					<?php else: ?>
						<div role="form" class="wpcf7" id="wpcf7-f1732-o1" lang="en-US" dir="ltr">
							...
							<form action="#" method="post" class="wpcf7-form" novalidate="novalidate">
								...
								<p><input type="submit" value="<?php _e( 'إرسال', 'illdy' ); ?>" class="wpcf7-form-control wpcf7-submit"></p>

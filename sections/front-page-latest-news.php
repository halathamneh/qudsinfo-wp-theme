...
<section id="latest-news" class="front-page-section">
	...
	<?php if( $button_text && $button_url ): ?>
		<a href="<?php echo esc_url( $button_url ); ?>" title="<?php echo esc_attr( $button_text ); ?>" class="latest-news-button"><?php echo esc_html( $button_text ); ?><i class="fa fa-chevron-circle-left"></i></a>
	<?php endif; ?>
	<?php
					...
					<?php while( $post_query->have_posts() ): ?>
						...
						<div class="col-md-4 col-sm-6 col-xs-12">
							<div class="post" style="<?php if( !$post_thumbnail ): echo 'padding-top: 40px;'; endif; ?>">
								...
								<?php endif; ?>
                                <div class="post-meta">
                                    <span class="post-meta-time"><i class="fa fa-clock-o"></i> <?= get_the_date(); ?></span>
                                </div>

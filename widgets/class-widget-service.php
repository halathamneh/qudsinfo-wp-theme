...
class Illdy_Widget_Service extends WP_Widget {
    ...
    */
    public function widget( $args, $instance ) {
        ...
        $link = !empty( $instance['link'] ) ? esc_attr( $instance['link'] ) : null;
        $color = ( !empty( $instance['color'] ) ? esc_attr( $instance['color'] ) : '#000000' );

        $output = '';

        $output .= '<a class="service-link" href="'.get_page_link($link).'"><div class="service" data-service-color="'. $color .'">';
            $output .= '<div class="service-icon-w">';
    ...
    */
    public function update( $new_instance, $old_instance ) {
        ...
        $instance['link'] = ( !empty( $new_instance['link'] ) ? sanitize_text_field( $new_instance['link'] ) : null );

...
if( !function_exists( 'illdy_sections_order' ) ) {
    function illdy_sections_order( $input ) {
        ...
        $latest_info_general_show = get_theme_mod( 'illdy_latest_info_general_show', 1 );
        $lectures_general_show = get_theme_mod( 'illdy_lectures_general_show', 1 );
        ...
        } elseif( $input == 3 && $testimonials_general_show == 1 ) {
        ...
        } elseif( $input == 9 && $latest_info_general_show == 1 ) {
            get_template_part( 'sections/front-page', 'latest-info' );
        } elseif( $input == 10 && $lectures_general_show == 1 ) {
            get_template_part( 'sections/front-page', 'lectures' );
        }
    }
}

...
if( !class_exists( 'MTL_Entry_Meta_Output' ) ) {
    ...
    class MTL_Entry_Meta_Output
    {
        ...
        protected function __construct() {
            ...
            add_action( 'mtl_single_news_entry_meta', array( $this, 'single_news_entry_meta_output' ), 1 );
            add_action( 'mtl_single_blog_entry_meta', array( $this, 'single_blog_entry_meta_output' ), 1 );
            add_action( 'mtl_archive_meta_content', array( $this, 'archive_entry_meta_output' ), 1 );
            add_action( 'mtl_archive_news_meta_content', array( $this, 'archive_news_entry_meta_output' ), 1 );
            add_action( 'mtl_archive_blog_meta_content', array( $this, 'archive_blog_entry_meta_output' ), 1 );
            add_action( 'mtl_single_after_content', array( $this, 'single_content_tags' ), 1 );
        }
         ...
         */
        public function archive_news_entry_meta_output() {
            global $post;
         ...
         *  Prints HTML with meta information for the current post-date/time and author on archive.
         */
        public function archive_blog_entry_meta_output() {
            global $post;

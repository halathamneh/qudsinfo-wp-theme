                            ...
                            <div class="col-md-3 col-6">
                                <div class="card team-member-card mb-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text"><?= SITE_POSITIONS[get_sub_field('job')]; ?></p>
                                        <?php
                                        $contact = get_sub_field('contact');
                                        if (filter_var($contact, FILTER_VALIDATE_EMAIL)) : ?>
                                            <a href="mailto:<?= $contact ?>" class="btn btn-link"><i
                                                        class="fa fa-envelope"></i> <?= __('Contact', 'qi-theme') ?></a>
                                        <?php else : ?>
                                            <a href="<?= $contact ?>" class="btn btn-link"><i
                                                        class="fa fa-link"></i> <?= __('Contact', 'qi-theme') ?></a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>

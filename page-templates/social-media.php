            ...
            while (have_posts()):
                ...
                <div class="entry-content">
                    ...
                    <?php if (have_rows('social_links')): ?>
                        <div class="social-icons row no-gutters justify-content-center">
                            ...
                            <?php while (have_rows('social_links')): the_row();
                                ...
                                ?>
                                <div class="icon-wrapper col-sm-4 col-6">
                                    <div class="icon <?= strtolower($classes) ?>">
                                        ...
                                        <div class="sm-link"><a
                                                    href="<?= $link ?>"><?= !empty($link) ? $link : "@qudsinfo" ?></a>
                                        </div>
                                    </div>
                                </div>
                            <?php endwhile; ?>

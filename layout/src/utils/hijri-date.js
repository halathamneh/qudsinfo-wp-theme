...
export default function convert(date, adjustment, lang) {
  var wdNames = wdNames_ar;
  var iMonthNames = lang === "en" ? iMonthNames_en : iMonthNames_ar;
